...
public class ProductService {
	...
	static void cancelOrder()
	{
		...
		for(int i=0;i<orderIndex;i++)
		{
			...
			{
				//this code will increase product stock after cancel
				for(int k=0;k<index;k++)  //loop for product
				{
					//checking if ordered product id matching with product id
				...
				//this code id is to delete order details from an array
